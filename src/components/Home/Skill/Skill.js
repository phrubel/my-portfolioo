...
const Skills = () => {
    return (
        <>
        <section className='skills  pt-5 pb-5 my-5 background'>
             <h1 className="text-center">MY <span>Education & Skills</span></h1>
            <div className='container mb-5 mt-5'>
                ...
                <div className="row text-white">
                    ...
                    <div className="col-md-6">
                        ...
                        <h3 >Comfortable</h3>
                        <div className="technology mb-5 shadow pb-3 p-3'"><span>Node.js</span><span>Express.js</span><span>MongoDB</span><span>Firebase</span><span>Material UI</span></div>
                        <h3>Familiar</h3>
